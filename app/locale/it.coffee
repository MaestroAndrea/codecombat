...
#    watch_how: "Watch how CodeCombat is transforming the way people learn computer science."
    top_screenshots_hint: "Gli studenti scrivono il codice e osservano le loro modifiche in tempo reale"
    designed_with: "Sviluppato pensando agli insegnanti"
    real_code: "Vero, codice scritto"
    from_the_first_level: "dal primo livello"
    getting_students: "Portare gli studenti a programmare il più velocemente possibile è fondamentale per imparare la sintassi e le strutture adatte."
    educator_resources: "Risorse Educatore"
    course_guides: "e guide ai corsi"
    teaching_computer_science: "Insegnare l'informatica non richiede aver conseguito una laurea costosa, perché diamo gli strumenti di supporto agli insegnanti che hanno avuto ogni tipo di formazione."
    accessible_to: "Accessibile a"
    everyone: "tutti"
    democratizing: "Democratizzare il processo di apprendimento della programmazione è il cuore della nostra filosofia. Tutti dovrebbero avere la possibilità di imparare a scrivere codice."
...
#    builds_concepts_up: "Mi piace come CodeCombat costruisce i concetti. È veramente facile capirli e metterli in pratica."
    why_games: "Perchè imparare attraverso il gioco è importante?"
#    games_reward: "La stimolante sfida delle ricompense nei giochi."
#    encourage: "Il gioco è un mezzo che incoraggia interazione, scoperta ed apprendimento per tentativo-correzione. Un buon gioco stimola ad impadronirsi di abilità nel tempo, come avviene quan."
#    excel: "La ricompensa porta all'eccellenza"
#    struggle: "sfida stimolante"
#    kind_of_struggle: "il tipo di sfida che rende lo studio coinvolgente e"
    motivating: "motivante"
#    not_tedious: "non noioso."
#    gaming_is_good: "Studi accertano che il gioco stimola positivamente il cervello dei bambini. (è vero!)"
#    game_based: "Quando gli apprendimenti sono basati sul gioco"
#    compared: "comparati"
#    conventional: "ai metodi tradizionali di insegnamento, la differenza è chiara: i giochi aiutano maggiormente gli studenti a ricordare conoscenze pregresse, mantenere la concentrazione"
#    perform_at_higher_level: "migliorare la performance e raggiungere obiettivi di livello superiore"
#    feedback: "I videogiochi danno anche agli allievi feedback in tempo reale permettendo loro di sistemare le soluzioni, le strade prese per arrivarci e capire i concetti in modo più olistico, invece di essere limitati dalle classiche risposte "giusto" o "sbagliato"."
    real_game: "Un vero videogioco, da affrontare attraverso la programmazione."
#    great_game: "Un buon videogioco è più di badges e conquiste - è una sorta di viaggio del giocatore, tra rompicapi ben strutturati ed illustrati, con l'abilità di affrontare con perizia e fiducia."
#    agency: "CodeCombat è un gioco che infonde al giocatore le necessarie perizia e fiducia tramite il nostro solido codice motore, che aiuta sia i principianti sia gli studenti più avanzati a scrivere, in maniera pulita, codici validi."
#    request_demo_title: "Fai iniziare i tuoi studenti oggi!"
#    request_demo_subtitle: "Richiedi una demo e, in meno di un'ora, fai partire i tuoi studenti."
#    get_started_title: "Crea la tua classe oggi"
#    get_started_subtitle: "Crea una classe, aggiungi i tuoi studenti, e monitora i loro progressi mentre studiano informatica."
    request_demo: "Richiedi una Demo"
#    setup_a_class: "Crea una Classe"
...
#    courses_available_in: "I corsi sono disponibili in JavaScript e in Python. I corsi di sviluppo Web utilizzano HTML, CSS, and jQuery."
#    boast: "Gli enigmi sono sufficientemente complessi da catturare l'attenzione sia dei giocatori e sia dei programmatori.."
#    winning: "Una vincente combinazione tra gioco RPG e compiti di programmazione che porta ad una piacevole istruzione a misura di bambino."
#    run_class: "Non c'è nessun bisogno di conoscenze informatiche per avviare già oggi un corso di informatica nella vostra scuola."
#    goto_classes: "Vai alle Mie Classi"
...
#    request_licenses: "Per maggiori informazioni contatta il nostro referente per le scuole"
...
#    subscribers_only: "Solo Membri!"
#    subscribe_unlock: "Iscriviti per sbloccare!"
#    subscriber_heroes: "Iscriviti oggi per sbloccare immediatamente Amara, Hushbaum, and Hattori!"
#    subscriber_gems: "Iscrivit oggi per comperare questo eroe con le gemme!"
...
#    brain_pop_done: "Hai sconfitto gli Orchi col tuo codice! Hai vinto!"
#    brain_pop_challenge: "Sfidati rigiocando usando un altro linguaggio!"
#    replay: "Replay"
#    back_to_classroom: "Torna alla Classe"
#    teacher_button: "Per Insegnanti"
#    get_more_codecombat: "Get More CodeCombat"
  ...
  share_progress_modal:
    blurb: "Stai facendo grandi progressi! Mostra ai tuoi genitori quanto hai imparato con CodeCombat."
...
#    sign_in_to_continue: "Log in o crea un account per accedere"
#    teacher_email_announcements: "Mantienimi aggiornato sulle novità per insegnanti: risorse, curriculum e corsi!"
...
#    hey_students: "Studente, inserisci il codice classe del tuo insegnante."
    birthday: "Compleanno"
#    parent_email_blurb: "Sappiamo che vuoi subito iniziare ad imparare a programmare &mdash; siamo emozioanti anche noi! I tuoi genitori riceveranno un email con tutte le informazioni necessarie per crearti un account. Per qualsiasi domanda, scrivici  {{email_link}} ."
#    classroom_not_found: "Non esistono Classi con questo Class Code. Controlla se hai scritto giusto o chiedi aiuto all'insegnante."
...
#    student_type_5: "Prepara il tuo Codice Classe!"
    signup_as_student: "Iscriviti come Studente"
    individuals_or_parents: "Individui e Genitori"
#    individual_type: "Per i giocatori che studiano fuori dalle classi i genitori dovrebbero creare un account qui."
#    signup_as_individual: "Sign up as an Individual"
#    enter_class_code: "Inserisci il tuo Codice Classe"
    enter_birthdate: "Inserisci la data di nascita:"
    parent_use_birthdate: "Genitori, usate la vostra data di nascita."
#    ask_teacher_1: "Chiedi al tuo insegnante Codice Classe."
#    ask_teacher_2: "Not part of a class? Creane una "
...
#    parent_email_error: "Qualcosa è andato storto nell'invio dell'email. Controlla l'indirizzo email e riprova."
#    parent_email_sent: "Abbiamo inviato un email con le indicazioni per creare un account. Chiedi ai tuoi genitori di controllare la posta in arrivo."
    account_created: "Account Creato!"
#    confirm_student_blurb: "Segnati queste informazioni in modo da non dimenticarle. Il tuo insegnante può aiutarti a resettare la password in ogni momento."
#    confirm_individual_blurb: "Segnati i tuoi dati di login perché ti serviranno più tardi. Verifica la tua email così puoi recuperare il tuo account in caso di perdita della password - controlla la tua posta in entrata!"
...
#    finish: "Finish"
#    teacher_ready_to_create_class: "Sei pronto per creare la tua prima classe!"
#    teacher_students_can_start_now: "I tuoi studenti potranno immediatamente seguire il primo corso di introduzione all'informatica."
#    teacher_list_create_class: "Nella prossima schermata potrai creare una nuova classe"
#    teacher_list_add_students: "Aggiungi studenti alla classe cliccando su Vedi Classe, poi comunica agli studenti il Codice Classe o l'URL. Se i tuoi studenti hanno un indirizzo email puoi anche invitarli tramite posta elettronica."
#    teacher_list_resource_hub_1: "Controlla le"
#    teacher_list_resource_hub_2: "Course Guides"
#    teacher_list_resource_hub_3: "per le soluzioni di ciascun livello, e il"
#    teacher_list_resource_hub_4: "Centro Risorse"
#    teacher_list_resource_hub_5: "per guide, attività, e molto altro!"
